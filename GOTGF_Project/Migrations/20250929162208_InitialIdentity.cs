    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Disaster_Alerts", x => x.AlertID);
                    table.ForeignKey(
                        name: "FK_Disaster_Alerts_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Disaster_Alerts_Projects_ProjectID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Volunteer_Assignment", x => x.AssignmentID);
                    table.ForeignKey(
                        name: "FK_Volunteer_Assignment_Projects_ProjectID",
                        column: x => x.ProjectID,
                        principalTable: "Projects",
                        principalColumn: "ProjectID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Volunteer_Assignment_Volunteers_VolunteerID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Disaster_Alerts_CreatedBy",
                table: "Disaster_Alerts",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Disaster_Alerts_ProjectID",
                table: "Disaster_Alerts",
                column: "ProjectID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Volunteer_Assignment_ProjectID",
                table: "Volunteer_Assignment",
                column: "ProjectID");

            migrationBuilder.CreateIndex(
                name: "IX_Volunteer_Assignment_VolunteerID",
                table: "Volunteer_Assignment",
                column: "VolunteerID");
